...
|-------------|-------|--------|
| SCHEMA-01 | Phase 1 — Schema Cleanup | Pending |
| SCHEMA-02 | Phase 1 — Schema Cleanup | Pending |
| SCHEMA-03 | Phase 1 — Schema Cleanup | Pending |
...
Last updated: 2026-05-19 (traceability populated by gsd-roadmapper)
